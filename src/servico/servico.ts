...
export const buscarHistoricoPorId = (id:any) => {
...
export const buscarHistoricoPorAno = (ano:any) => {
...
export const calcularReajuste = (valor:number, dataInicialMes:number , dataInicialAno: number, dataFinalMes: number, dataFinalAno: number) => {
...
export const validacaoErro = ( valor: number, dataInicialMes: number, dataInicialAno: number, dataFinalMes: number, dataFinalAno: number) => {
